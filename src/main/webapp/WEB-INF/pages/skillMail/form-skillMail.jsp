        ...
        <form onsubmit="return false;">
            ...
            <div class="col-md-4 m-b-15">
                ...
                <div class="input-icon datetime-pick date-only">
                    <input id="input_day" data-format="yyyy-MM-dd" class="form-control input-sm validate[required]"
                           type="text">
                    <span class="add-on">
            ...
            <div class="col-md-4 m-b-15">
                ...
                <div class="input-icon datetime-pick time-only">
                    <input id="input_time" data-format="hh:mm:ss" class="form-control input-sm validate[required]"
                           type="text">
                    <span class="add-on">
								<i class="sa-plus icon-calendar"></i>
							</span>
            ...
            <div class="col-md-12 m-b-15">
                <input id="submitMail" class="submit btn btn-sm" value="提交" type="button"
                       onclick="submitMailFunction();">
            </div>
        </form>
    </div>
